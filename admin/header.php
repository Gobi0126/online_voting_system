...
<html lang="en" dir="ltr">
  <head>
    ...
    if (session_status() === PHP_SESSION_NONE) {
     ...
     $id= $_SESSION['id'];
     $query21="select name from admin where id = $id";
     $a1= mysqli_query($conn23,$query21);
  ...
  <body >
    <div class="Nav" id="Nav1" style="background: black;">
      ...
      <h1 class="NavLogo" onclick="rtohome()">KEC</h1>
        <div class="MobileIcon">
        <i class="fa fa-bars"></i>
        </div>
        <ul class="NavMenu ">
          <li style="color:white;padding-top:30px; margin-left:250px; font-family:algerian" class="NavItem"><?php echo "Welcome   $a !!!" ; ?></li>
        </ul>
        <!-- <ul class="NavMenu ">
