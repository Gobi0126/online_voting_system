...
function search(){
  window.location.href ="userssearch.php";
}
function requests(){
...
<div class="wrapper">
   ...
   <div class="content">
      <!-- card -->
      <div class="card" onclick="search()">

            <div class="icon"><i class="material-icons md-36" >search</i></div>
            <p class="title">Voters</p>
            <p class="text">Check all voters</p>

      </div>
      <!-- end card -->

      <!-- card -->
      <div class="card" onclick="votes()">

            <div class="icon"><i class="material-icons md-36">add</i></div>
            <p class="title">Votes</p>
            <p class="text">Candidates position</p>
         ...
         <p class="text">Check all candidates</p>
